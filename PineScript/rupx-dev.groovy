...
sol_dot(fibL nFibL, sol_dot, col) =>
    style = 
     sol_dot ==  'dot'  ? 
      line.style_dotted : 
     sol_dot ==  'sol'  ? 
...
set(fibL nFibL, int x1, int x2, float max_500, float max_618, float max_764, float max_854, float y2) =>
        ...
        if barstate.islast
            ...
            if aEW.size() > 1
                ...
                // –––[ get.on == true ~ valid EW ]–––
                    ...
                    //
                    set(nFibL, last_6x, bar_index + 10, max_500, max_618, max_764, max_854, last_6y)
            ...
            switch nFibL._break_
                true  => sol_dot(nFibL,'dot', color.new(color.red , 95))
                false => sol_dot(nFibL,'sol', color.new(color.lime, 95))
                => 
                    nFibL.wave1_0_500.set_xy1(na, na)
                    nFibL.wave1_0_500.set_xy2(na, na)
                    nFibL.wave1_0_618.set_xy1(na, na)
